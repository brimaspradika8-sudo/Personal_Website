        ...
        <div className="w-full md:w-[54%] p-6 sm:p-10 flex flex-col justify-center bg-white dark:bg-[#0E121D]">
          <div className="space-y-6 max-w-sm w-full mx-auto text-left">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative flex items-center">
                  <input
                    ...
                    placeholder="••••••••"
                    className="w-full bg-slate-50 dark:bg-slate-900 border-2 border-slate-900 dark:border-white rounded-none px-3.5 py-3 pl-9 pr-10 text-sm text-slate-950 dark:text-white placeholder:text-slate-400 focus:outline-none focus:bg-white dark:focus:bg-slate-950 focus:border-[#166534] transition-all"
                  />
                ...
                <div className="flex justify-end pt-1">
                  <Link
                    ...
                    className="text-[11px] font-bold text-[#166534] hover:underline uppercase"
                  >
                    FORGOT PASSWORD?
                  </Link>
                </div>
            ...
            <div className="flex items-center gap-3 text-xs text-slate-500 pt-1">
              ...
              <span className="text-[11px] font-bold text-slate-950 dark:text-white uppercase">OR SIGN IN WITH</span>
              <div className="h-0.5 flex-1 bg-slate-900 dark:bg-white" />
            </div>
