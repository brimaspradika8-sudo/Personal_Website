...
function RegisterForm() {
  ...
  const debouncedRegister = useDebouncedAction(async (formData: FormData) => {
    ...
    try {
      ...
      const msg = err instanceof Error ? err.message : "An error occurred while registering.";
      setError(msg);
    } finally {
      setLoading(false);
    }
  ...
  return (
    <div className="relative min-h-[100dvh] w-full flex flex-col items-center justify-center p-4 sm:p-6 text-slate-900 bg-[#F4F4F0] dark:bg-[#05080E] dark:text-white selection:bg-[#166534] selection:text-white">
      ...
      <div className="relative z-10 w-full max-w-4xl bg-white dark:bg-[#0E121D] border-2 sm:border-4 border-slate-900 dark:border-white rounded-none overflow-hidden flex flex-col md:flex-row my-auto shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:shadow-[4px_4px_0px_0px_rgba(255,255,255,1)]">
        ...
        <div className="w-full md:w-[46%] bg-amber-400/20 dark:bg-amber-400/10 p-5 sm:p-8 flex flex-col justify-center items-center border-b-2 md:border-b-0 md:border-r-2 border-slate-900 dark:border-white shrink-0 relative">
          ...
          <div className="text-center mt-3 sm:mt-4 space-y-1">
            ...
            <p className="text-[11px] font-bold text-slate-700 dark:text-slate-300 bg-amber-400 text-slate-950 px-2 py-0.5 rounded border border-slate-900 inline-block uppercase">
        ...
        <div className="w-full md:w-[54%] p-6 sm:p-10 flex flex-col justify-center bg-white dark:bg-[#0E121D]">
          <div className="space-y-6 max-w-sm w-full mx-auto text-left">
            ...
            <div className="text-left space-y-1">
              <span className="text-[10px] font-bold uppercase tracking-widest px-2.5 py-0.5 bg-[#166534] text-white border-2 border-slate-900 dark:border-white rounded-md shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
                USER REGISTRATION
              </span>
              <h1 className="text-2xl sm:text-3xl font-black tracking-tight text-slate-950 dark:text-white uppercase pt-1">
                SIGN UP
              </h1>
            ...
            {error && (
              <div className="rounded-xl border-2 border-slate-900 bg-red-100 text-red-950 p-3.5 text-xs font-bold shadow-[3px_3px_0px_0px_rgba(0,0,0,1)]">
                <span>{error}</span>
              </div>
            )}

            {success && (
              <div className="rounded-xl border-2 border-slate-900 bg-emerald-100 text-emerald-950 p-3.5 text-xs font-bold shadow-[3px_3px_0px_0px_rgba(0,0,0,1)]">
                <span>Registration successful. Redirecting to the login page...</span>
              </div>
            )}
            ...
            >
              <div className="space-y-1.5">
                <label htmlFor="name" className="block text-xs font-bold text-slate-900 dark:text-white uppercase tracking-wider">
                  FULL NAME
                </label>
                <div className="relative flex items-center">
                  <input
                    ...
                    className="w-full bg-slate-50 dark:bg-slate-900 border-2 border-slate-900 dark:border-white rounded-none px-3.5 py-3 pl-9 text-sm text-slate-950 dark:text-white placeholder-slate-400 focus:outline-none focus:bg-white dark:focus:bg-slate-950 focus:border-[#166534] transition-all"
                  />
              ...
              <div className="space-y-1.5">
                <label htmlFor="email" className="block text-xs font-bold text-slate-900 dark:text-white uppercase tracking-wider">
                  EMAIL ADDRESS
                </label>
                <div className="relative flex items-center">
                  <input
              ...
              <div className="space-y-1.5">
                <label htmlFor="password" className="block text-xs font-bold text-slate-900 dark:text-white uppercase tracking-wider">
                  PASSWORD
                </label>
                <div className="relative flex items-center">
                  <input
                    ...
                    className="w-full bg-slate-50 dark:bg-slate-900 border-2 border-slate-900 dark:border-white rounded-none px-3.5 py-3 pl-9 pr-10 text-sm text-slate-950 dark:text-white placeholder-slate-400 focus:outline-none focus:bg-white dark:focus:bg-slate-950 focus:border-[#166534] transition-all"
                  />
                  ...
                  <button
                    ...
                    tabIndex={-1}
                    className="absolute right-3 text-slate-950 dark:text-white hover:text-[#166534] p-1 cursor-pointer"
              ...
              <div className="pt-2">
                <button
                  ...
                  className="w-full rounded-none bg-[#166534] text-white border-2 border-slate-900 dark:border-white py-3 px-4 text-xs font-black uppercase tracking-wider transition-all disabled:opacity-50 flex items-center justify-center gap-2 cursor-pointer shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] dark:shadow-[2px_2px_0px_0px_rgba(255,255,255,1)] hover:bg-[#EAB308] hover:text-slate-950 active:translate-x-0.5 active:translate-y-0.5 active:shadow-none"
                >
                  {loading && (
            ...
            <div className="flex items-center gap-3 text-xs text-slate-500 pt-1">
              ...
              <span className="text-[11px] font-bold text-slate-950 dark:text-white uppercase">OR SIGN UP WITH</span>
              <div className="h-0.5 flex-1 bg-slate-900 dark:bg-white" />
            </div>
            ...
            <div className="grid grid-cols-2 gap-2.5">
              <button
                ...
                disabled={isAnyLoading}
                className="flex items-center justify-center gap-2 rounded-xl border-2 border-slate-900 dark:border-white bg-white dark:bg-slate-900 py-2.5 px-3 text-xs font-bold text-slate-950 dark:text-white transition-all disabled:opacity-50 cursor-pointer shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] dark:shadow-[3px_3px_0px_0px_rgba(255,255,255,1)] hover:bg-slate-100 dark:hover:bg-slate-800"
              >
            ...
            <div className="pt-2 text-center">
              <p className="text-xs font-bold text-slate-600 dark:text-slate-400 uppercase">
                ...
                <Link
                  href="/login"
                  className="font-black text-[#166534] hover:underline"
                >
                  SIGN IN HERE
                </Link>
              </p>
