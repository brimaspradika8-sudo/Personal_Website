...
export default function ArticleClient({
  ...
  const renderReadingBadge = (className = "") => (
    <span className={`inline-flex w-max items-center gap-1.5 rounded-none bg-[#166534] text-white text-[10px] font-mono font-black uppercase shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] ${className}`}>
