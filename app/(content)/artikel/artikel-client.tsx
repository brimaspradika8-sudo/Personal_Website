      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 pt-8 sm:pt-12 space-y-8">
        ...
        <div className="space-y-3 text-left">
          ...
          <h1 className="font-mono text-3xl sm:text-5xl font-black uppercase tracking-tight text-black dark:text-white leading-none">
            ARTIKEL &amp; <span className="bg-[#FFFF00] text-black px-2 py-0.5 border-3 border-black">PANDUAN TEKNIS</span>
          </h1>
        ...
        {/* 3. SEARCH & PURE BRUTALISM CATEGORY TAB BAR */}
        <div className="p-4 sm:p-6 rounded-none border-4 border-black dark:border-white bg-white dark:bg-black shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] dark:shadow-[6px_6px_0px_0px_rgba(255,255,255,1)] space-y-4">
          ...
          {/* Pure Brutalism Category Tab Bar */}
            ...
            {CATEGORIES.map((cat) => {
              ...
              return (
                <button
                  ...
                  className={`px-4 py-2 rounded-none text-xs font-mono font-black transition-all shrink-0 cursor-pointer border-3 border-black dark:border-white uppercase ${
                    isActive
            ...
            {filteredArticles.map((article) => (
              ...
              >
                ...
                <div className="relative w-full h-48 bg-black border-b-4 border-black dark:border-white overflow-hidden shrink-0">
                  ...
                  {/* Category Badge */}
                  <div className="absolute top-3 left-3 px-3 py-1 rounded-none bg-[#FF0000] text-white border-2 border-black text-[10px] font-mono font-black uppercase shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
