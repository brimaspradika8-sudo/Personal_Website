                  ...
                  <div className="p-6 bg-white dark:bg-[#0A0D14] border-4 border-black dark:border-white shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] dark:shadow-[6px_6px_0px_0px_rgba(255,255,255,1)] flex flex-col justify-between space-y-5">
                    <div className="flex items-center justify-between border-b-3 border-black dark:border-white pb-3">
                      ...
                      <button
                        ...
                        className="px-3 py-1 bg-slate-100 dark:bg-slate-900 border-2 border-black dark:border-white text-xs font-mono font-black uppercase text-black dark:text-white shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:bg-[#FFFF00] hover:text-black transition-colors flex items-center gap-1 cursor-pointer"
                      >
                        <span>KELOLA</span>
                        ...
                        recentProjects.map((p) => (
                          ...
                          >
                            ...
                            <button
                              ...
                              className="px-3 py-1 bg-[#FFFF00] text-black border-2 border-black text-xs font-mono font-black uppercase shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:bg-black hover:text-white transition-colors shrink-0 cursor-pointer"
                            >
                              DETAIL
                            </button>
                          </div>
