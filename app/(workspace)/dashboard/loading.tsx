    ...
    <div className="min-h-screen bg-[#F8F9FA] dark:bg-[#0A0D14] text-slate-900 dark:text-white font-sans antialiased pb-28 sm:pb-20 selection:bg-[#EAB308] selection:text-slate-950">
      ...
      <header className="fixed top-3 sm:top-5 left-1/2 -translate-x-1/2 z-50 w-[94%] max-w-6xl rounded-full border-2 sm:border-3 border-slate-900 dark:border-white bg-white/90 dark:bg-[#0E121D]/90 backdrop-blur-md font-mono shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:shadow-[4px_4px_0px_0px_rgba(255,255,255,1)] px-3.5 sm:px-6 py-2 sm:py-2.5">
        <div className="flex items-center justify-between gap-2 sm:gap-4">
          ...
          <div className="hidden md:flex items-center gap-1.5 bg-slate-100/80 dark:bg-slate-900/80 px-3 py-1.5 rounded-full border border-slate-900/20 dark:border-white/20 text-xs font-bold uppercase">
            <span className="px-2.5 py-1 bg-[#166534] text-white rounded-full">BERANDA</span>
            <span className="px-2.5 py-1 text-slate-700 dark:text-slate-300">TENTANG</span>
            <span className="px-2.5 py-1 text-slate-700 dark:text-slate-300">PROYEK</span>
            <span className="px-2.5 py-1 text-slate-700 dark:text-slate-300">ARTIKEL</span>
          </div>

          <div className="flex items-center gap-2 shrink-0">
            <div className="w-9 h-7 rounded-full bg-[#EAB308] border-2 border-slate-900 shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] flex items-center justify-center text-xs font-black">
              ID
            </div>
          </div>
