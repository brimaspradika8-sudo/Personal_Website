export default function GlobalLoading() {
  return (
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-white dark:bg-black text-black dark:text-white font-mono antialiased selection:bg-[#EAB308] selection:text-slate-950 p-4">
      <div className="flex flex-col items-center space-y-6 text-center">
        {/* Signature Neo-Brutalist Animated Square Box */}
        <div className="relative w-20 h-20">
          <div className="absolute inset-0 bg-[#166534] border-4 border-black dark:border-white shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] dark:shadow-[6px_6px_0px_0px_rgba(255,255,255,1)] animate-bounce" />
